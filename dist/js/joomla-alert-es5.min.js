...
function r(e, n) {
  return !n || "object" !== t(n) && "function" != typeof n ? i(e) : n;
}
...
var f = function (t) {
  ...
  function d() {
    ...
    }(this, d), (t = y.call(this)).close = t.close.bind(i(t)), t.destroyCloseButton = t.destroyCloseButton.bind(i(t)), t.createCloseButton = t.createCloseButton.bind(i(t)), t.onMutation = t.onMutation.bind(i(t)), t.observer = new MutationObserver(t.onMutation), t.observer.observe(i(t), {
      attributes: !1,
      childList: !0,
      subtree: !0
    }), t;
  ...
  return f = d, b = [{
    ...
    value: function value() {
      this.type && ["info", "warning", "danger", "success"].includes(this.type) || this.setAttribute("type", "info"), this.role && ["alert", "alertdialog"].includes(this.role) || this.setAttribute("role", "alert"), this.firstElementChild && "BUTTON" === this.firstElementChild.tagName && (this.button = this.firstElementChild, this.button.classList.contains("joomla-alert--close") && this.button.classList.add("joomla-alert--close"), "" === this.button.innerHTML && (this.button.innerHTML = '<span aria-hidden="true">&times;</span>'), this.button.hasAttribute("aria-label") || this.button.setAttribute("aria-label", this.closeText)), this.hasAttribute("dismiss") && !this.button && this.createCloseButton(), this.hasAttribute("auto-dismiss") && this.autoDismiss(), this.dispatchEvent(new CustomEvent("joomla.alert.show"));
    }
  }, {
    ...
    value: function value(t, e, n) {
      switch (t) {
        ...
        case "dismiss":
          n && "" !== n || e && "" !== e || (this.button && !this.hasAttribute("dismiss") ? this.destroyCloseButton() : !this.button && this.hasAttribute("dismiss") && this.createCloseButton());
          break;
    ...
    value: function value(t) {
      ...
      try {
        for (o.s(); !(n = o.n()).done;) {
          var r = n.value;
          "childList" === r.type && r.addedNodes.length && this.button && this.firstElementChild !== this.button && this.prepend(this.button);
        }
      } catch (t) {
        o.e(t);
      } finally {
    ...
    key: "close",
    value: function value() {
      this.dispatchEvent(new CustomEvent("joomla.alert.close")), this.remove();
    }
  }, {
