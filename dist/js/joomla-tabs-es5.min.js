  ...
  return i = h, l = [{
    ...
    value: function value(t) {
      ...
      try {
        for (r.s(); !(e = r.n()).done;) {
          var a = e.value;
          "childList" === a.type && (a.addedNodes.length && [].slice.call(a.addedNodes).map(function (t) {
            return i.createNavs(t);
          }), a.removedNodes.length && [].slice.call(a.addedNodes).map(function (t) {
    ...
    key: "createNavs",
    value: function value(t) {
      if (t.getAttribute("name") && t.getAttribute("id")) {
        ...
        r.setAttribute("aria-expanded", !!t.hasAttribute("active")), r.setAttribute("aria-controls", t.id), r.setAttribute("role", "tab"), r.innerHTML = "".concat(t.getAttribute("name")), e.length - 1 === n ? (this.tabButtonContainer.appendChild(r), this.tabs.push({
          tab: t,
          tabButton: r,
          accordionButton: i
        })) : 0 === n ? (this.tabButtonContainer.insertAdjacentElement("afterbegin", r), this.tabs.slice(0, 0, {
          tab: t,
          tabButton: r,
          accordionButton: i
        })) : (this.tabs[n - 1].tabButton.insertAdjacentElement("afterend", r), this.tabs.slice(n - 1, 0, {
          tab: t,
          tabButton: r,
          accordionButton: i
        })), r.addEventListener("click", this.activateTab);
      }
    }
  }, {
    key: "removeNavs",
