...
var f = function (t) {
  ...
  function m() {
    ...
    }(this, m), (t = d.call(this)).close = t.close.bind(r(t)), t.destroyCloseButton = t.destroyCloseButton.bind(r(t)), t.createCloseButton = t.createCloseButton.bind(r(t)), t.onMutation = t.onMutation.bind(r(t)), t.observer = new MutationObserver(t.onMutation), t.observer.observe(r(t), {
      attributes: !1,
      childList: !0,
      subtree: !0
  ...
  return f = m, b = [{
    ...
    set: function set(t) {
      return this.setAttribute("close-text", t);
    }
  }, {
    key: "dismiss",
    get: function get() {
    ...
    set: function set(t) {
      return this.setAttribute("dismiss", t);
    }
  }, {
    key: "autodismiss",
    get: function get() {
    ...
    set: function set(t) {
      return this.setAttribute("auto-dismiss", t);
    }
  }, {
    key: "connectedCallback",
    value: function value() {
      this.style.animationName = "joomla-alert-fade-in", this.dispatchEvent(new CustomEvent("joomla.alert.show")), this.type && ["info", "warning", "danger", "success"].includes(this.type) || this.setAttribute("type", "info"), this.role && ["alert", "alertdialog"].includes(this.role) || this.setAttribute("role", "alert"), this.firstElementChild && "BUTTON" === this.firstElementChild.tagName && (this.button = this.firstElementChild, this.button.classList.contains("joomla-alert--close") && this.button.classList.add("joomla-alert--close"), "" === this.button.innerHTML && (this.button.innerHTML = '<span aria-hidden="true">&times;</span>'), this.button.hasAttribute("aria-label") || this.button.setAttribute("aria-label", this.closeText)), this.hasAttribute("dismiss") && !this.button && this.createCloseButton(), this.hasAttribute("auto-dismiss") && this.autoDismiss();
    }
  }, {
    ...
    value: function value(t, e, n) {
      switch (t) {
        ...
        case "dismiss":
          this.button && !this.hasAttribute("dismiss") ? this.destroyCloseButton() : !this.button && this.hasAttribute("dismiss") && this.createCloseButton();
          break;
    ...
    value: function value() {
      this.button = document.createElement("button"), this.button.classList.add("joomla-alert--close"), this.button.innerHTML = '<span aria-hidden="true">&times;</span>', this.button.setAttribute("aria-label", this.closeText), this.insertAdjacentElement("afterbegin", this.button), this.button.addEventListener("click", this.close);
    }
  }, {
