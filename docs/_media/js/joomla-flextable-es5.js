...
(function () {
  ...
  function (_HTMLElement) {
    _inherits(joomlaFlexTable, _HTMLElement);

    function joomlaFlexTable() {
      _classCallCheck(this, joomlaFlexTable);

      return _possibleConstructorReturn(this, _getPrototypeOf(joomlaFlexTable).apply(this, arguments));
    }

    _createClass(joomlaFlexTable, [{
      ...
      value: function connectedCallback() {
        ...
        var items = _toConsumableArray(this.querySelectorAll('.page-link'));
        /* has arrow */
