  ...
  return h = p, f = [{
    ...
    value: function value() {
      ...
      if (this.setAttribute("aria-labelledby", t), !this.header) {
        ...
        o.setAttribute("aria-label", "Close"), o.setAttribute("data-dismiss", ""), o.innerHTML = '<span aria-hidden="true">×</span>';
...
customElements.get("joomla-modal") || customElements.define("joomla-modal", u);
