...
var _createClass = function () {
  ...
  function b() {
    _classCallCheck(this, b);var a = _possibleConstructorReturn(this, (b.__proto__ || Object.getPrototypeOf(b)).call(this));if (!document.getElementById('joomla-alert-stylesheet')) {
      ...
      'level' === a ? -1 === ['info', 'warning', 'danger', 'success'].indexOf(c) && this.setAttribute('level', b) : 'dismiss' === a || 'acknowledge' === a ? c && 'true' !== c && c && 'true' !== c ? this.removeCloseButton() : this.appendCloseButton() : 'href' === a ? c && '' !== c ? !this.querySelector('button.joomla-alert-button--close') && this.appendCloseButton() : this.removeCloseButton() : void 0;
