...
var m = function (t) {
  ...
  function d() {
    var t;
    return r(this, d), (t = h.call(this)).tabs = [], t.tabsElements = [], t.previousActive = null, t.onMutation = t.onMutation.bind(u(t)), t.keyBehaviour = t.keyBehaviour.bind(u(t)), t.activateTab = t.activateTab.bind(u(t)), t.deactivateTabs = t.deactivateTabs.bind(u(t)), t.checkView = t.checkView.bind(u(t)), t.observer = new MutationObserver(t.onMutation), t.observer.observe(u(t), {
      attributes: !1,
      childList: !0,
      subtree: !0
    }), t;
    ...
    value: function value() {
      ...
      if ((!this.orientation || this.orientation && !["horizontal", "vertical"].includes(this.orientation)) && (this.orientation = "horizontal"), (!this.view || this.view && !["tabs", "accordion"].includes(this.view)) && (this.view = "tabs"), this.tabsElements = [].slice.call(this.children).filter(function (t) {
        ...
        if (this.isNested = this.parentNode.closest("joomla-tab") instanceof HTMLElement, this.hydrate(), this.hasAttribute("recall") && !this.isNested && this.activateFromState(), window.location.hash) {
          ...
          console.log(n), n.length && this.activateTab(n[0].tab);
        }
