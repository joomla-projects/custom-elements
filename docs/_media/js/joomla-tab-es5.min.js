...
var m = function (t) {
  ...
  return i = d, l = [{
    ...
    value: function value() {
      ...
      }), this.tabsElements.length && (this.isNested = this.parentNode.closest("joomla-tab") instanceof HTMLElement, this.hydrate(), this.hasAttribute("recall") && !this.isNested && this.activateFromState(), this.tabs.filter(function (t) {
