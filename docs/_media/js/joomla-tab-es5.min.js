...
var m = function (t) {
  ...
  function d() {
    var t;
    return r(this, d), (t = h.call(this)).tabs = [], t.tabsElements = [], t.onMutation = t.onMutation.bind(c(t)), t.keyBehaviour = t.keyBehaviour.bind(c(t)), t.activateTab = t.activateTab.bind(c(t)), t.deactivateTabs = t.deactivateTabs.bind(c(t)), t.checkView = t.checkView.bind(c(t)), t.observer = new MutationObserver(t.onMutation), t.observer.observe(c(t), {
      attributes: !1,
      childList: !0,
      subtree: !0
    }), t;
