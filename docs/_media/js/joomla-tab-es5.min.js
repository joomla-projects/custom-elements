...
var p = function (t) {
  ...
  function h() {
    var t;
    return r(this, h), (t = d.call(this)).tabs = [], t.tabsElements = [], t.onMutation = t.onMutation.bind(c(t)), t.keyBehaviour = t.keyBehaviour.bind(c(t)), t.activateTab = t.activateTab.bind(c(t)), t.deactivateTabs = t.deactivateTabs.bind(c(t)), t.checkView = t.checkView.bind(c(t)), t.observer = new MutationObserver(t.onMutation), t.observer.observe(c(t), {
      attributes: !1,
      childList: !0,
      subtree: !0
    }), t;
  ...
  return i = h, l = [{
    ...
    value: function value() {
      ...
      }), this.tabsElements.length && (this.hydrate(), this.hasAttribute("recall") && this.activateFromState(), this.tabs.filter(function (t) {
        return t.tab.hasAttribute("active");
      }).length || this.tabs[0].tabButton.click(), this.addEventListener("keyup", this.keyBehaviour), this.breakpoint && (this.checkView(), window.addEventListener("resize", function () {
        t.checkView();
      })));
    }
  }, {
    ...
    key: "removeNavs",
    value: function value(t) {
      if ("joomla-tab-element" === t.tagName.toLowerCase() && this.tabs.filter(function (e) {
        return e.tab === t;
      }) && t.getAttribute("name") && t.getAttribute("id")) {
    ...
    value: function value() {
      ...
      if (e) {
        ...
        if (i >= 0) this.activateTab(i, !1);else if (this.querySelector("joomla-tabs")) {
          [].slice.call(this.querySelectorAll("joomla-tab-element")).forEach(function (i) {
            i.parentNode !== t && (i.removeAttribute("active"), i.id === e && (i.setAttribute("active", ""), n = i));
          });
          var a = n.parentNode.closest("joomla-tab-element");
  ...
  }]) && a(i.prototype, u), l && a(i, l), h;
}();

customElements.define("joomla-tab", p);
