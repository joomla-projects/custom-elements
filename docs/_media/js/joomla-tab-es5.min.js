...
var s = function (t) {
  ...
  return u = d, h = [{
        ...
        if (this.hasNested) {
          ...
          if (a && n.push(a), n.length && "" !== n[0]) {
            var c = n[0].substring(5),
                s = this.querySelector("#".concat(c));

            if (s) {
              var u = s.closest("joomla-tab");

              if (this.isNested) {
                var l = u.closest("section");
    ...
    value: function value(t) {
      ...
      if (document.body.getBoundingClientRect().width > 920) {
        ...
        for (var c = [].slice.call(e.querySelectorAll("section")), s = 0, u = c.length; s < u; ++s) {
          c[s].parentNode === e && i.push(c[s]);
        }
  ...
  }]) && e(u.prototype, l), h && e(u, h), d;
}();

customElements.get("joomla-tab") || customElements.define("joomla-tab", s);
