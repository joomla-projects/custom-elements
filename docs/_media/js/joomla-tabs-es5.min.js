  ...
  return i = h, l = [{
    ...
    value: function value(t) {
      if ("joomla-tab-element" === t.tagName.toLowerCase() && [].some.call(this.children, function (e) {
        ...
        a.setAttribute("aria-expanded", !!t.hasAttribute("active")), a.setAttribute("aria-controls", t.id), a.setAttribute("role", "tab"), a.innerHTML = "".concat(t.getAttribute("name")), e.length - 1 === n ? (this.tabButtonContainer.appendChild(a), this.tabs.push({
          tab: t,
          tabButton: a,
          accordionButton: i
