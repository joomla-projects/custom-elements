...
var _createClass = function () {
  ...
  function b() {
    return _classCallCheck(this, b), _possibleConstructorReturn(this, (b.__proto__ || Object.getPrototypeOf(b)).call(this));
      ...
      var b = a.parentNode,
          c = b.querySelectorAll('input.active'),
          d = [].slice.call(b.querySelectorAll('input')),
          e = [].slice.call(b.nextElementSibling.querySelectorAll('span'));e.forEach(function (a) {
        a.classList.remove('active');
      }), b.classList.contains('active') ? b.classList.remove('active') : b.classList.add('active'), a.classList.contains('active') ? (d.forEach(function (a) {
        a.classList.remove('active'), a.removeAttribute('checked');
      }), this.dispatchCustomEvent('joomla.switcher.off')) : (d.forEach(function (a) {
        a.classList.remove('active'), a.removeAttribute('checked');
